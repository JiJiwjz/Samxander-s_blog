...
| [astro-pure](https://github.com/cworld1/astro-theme-pure) | 1.4.1 | 博客主题 |
| TypeScript | 5.9.3 | 类型系统 |
| UnoCSS | 66.6.7 | 原子化 CSS 框架 |
...
| [Cloudflare](https://cloudflare.com) | DNS 解析 + CDN 加速 |
...
|------|------|
| Markdown / MDX | 博客文章格式 |
| Astro Content Collections | 内容管理，frontmatter 类型校验 |
...
| 技术 | 说明 |
|------|------|
| [Waline](https://waline.js.org) | 评论系统 + 文章阅读计数 |
| Waline 服务 | 部署于 Vercel：`waline-server-lac-nine.vercel.app` |
| 数据库 | [Supabase](https://supabase.com)（免费 PostgreSQL） |
...
| 技术 | 说明 |
|------|------|
| Satoshi | 主字体，来自 Fontshare |
| Astro Experimental Fonts | 字体预加载优化 |
| 系统字体 fallback | `-apple-system, BlinkMacSystemFont, 'Segoe UI'` |
...
| push_gui.py (PyQt5) | 一键 Git 推送桌面工具 |
